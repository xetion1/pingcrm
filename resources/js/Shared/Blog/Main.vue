...
<div class="bg-pink-400 h-screen w-full flex justify-center items-center rounded">
            ...
            <div class="bg-my-color text-white w-full h-full flex justify-center items-center px-3 text-center">
                <div class="h-full px-8 text-gray-100 lg:text-lg">
                    ...
                    <div class="font-sans md:mb-3 mb-2">
                        <h2 class="uppercase font-medium">Eleana Gkogka</h2>
                        <p>Artist &amp; Designer</p>
                    </div>
                    <p class="lg:text-md text-sm">
                        Pasiulikite blogs temas kad mes atsakytume jas ir sukurtume pacius geriaus blogus kurie gali buti
                        ir ne tik <br>
                        Forma <br>
                        vardas Pavarde <br>
                        Tema <br>
