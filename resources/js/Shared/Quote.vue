...
<div class="flex justify-center items-center w-90 h-66 bg-gray-700">
	...
	<div class="container mx-auto mt-10 mb-10 lg:mb-40 lg:px-20">
		<div class="relative w-full my-4 lg:w-9/12 mr-auto rounded-2xl shadow-2xl">
			<img alt="Card" src="https://cavsnation.com/wp-content/uploads/2018/05/lebron-james-2.jpg" class="max-w-full rounded-lg shadow-lg"/>
        </div>
		<div class="relative w-full lg:-mt-96 lg:w-3/6 p-8 ml-auto bg-blue-800 rounded-2xl z-50">
		    <div class="flex flex-col text-white">
                ...
                <div class="flex justify-between pl-2">
                    <h3 class="font-bold text-2xl ">LeBron James</h3>
